...
struct Color {
    ...
    static constexpr std::string reset() {
        return reset(ResetModifier::All);
    }
    ...
    static constexpr std::string color(ForegroundColor foreground, BackgroundColor background) {
    ...
    static constexpr std::string color(ForegroundColor foreground, BackgroundColor background, Modifier modifier) {
    ...
    static constexpr std::string color(ForegroundColor foreground, Modifier modifier) {
...
struct std::formatter<ForegroundColor, CharT> : std::formatter<std::string, CharT> {
